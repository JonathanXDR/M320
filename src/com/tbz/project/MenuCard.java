...
public class MenuCard {
    ...
    public MenuCard() {
        ...
        products.put("Pizza", new Meal("Pizza", 12.00, new ArrayList<Topping>(Arrays.asList(
                toppings.get("Salat"),
                toppings.get("Tomate"),
                toppings.get("Käse"),
                toppings.get("Zwiebeln")
        ))));
        products.put("Burger", new Meal("Burger", 12.00, new ArrayList<Topping>(Arrays.asList(
                toppings.get("Salat"),
                toppings.get("Tomate"),
                toppings.get("Käse"),
                toppings.get("Sauce"),
        ...
        products.put("Döner", new Meal("Döner", 10.00, new ArrayList<Topping>(Arrays.asList(
                toppings.get("Salat"),
                toppings.get("Tomate"),
                toppings.get("Käse"),
                toppings.get("Sauce"),
        ...
        products.put("Cola", new Drink("Cola", 2.50));
        products.put("Fanta", new Drink("Fanta", 2.50));
